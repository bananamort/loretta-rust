...
pub fn category_of(cp: u32) -> u8 {
    match cp {
        // ASCII per .NET CharUnicodeInfo (Unicode 16.0): the generated table
        // had collapsed 0..=127 to Control; characters not listed in
        // needs_escaping's explicit switch (e.g. '"', '$', '\'', '\\', '^',
        // '~') reach this check, so the categories must be exact.
        0x00..=0x1F => 14,
        0x20 => 11,
        0x21 => 24,
        0x22 => 24,
