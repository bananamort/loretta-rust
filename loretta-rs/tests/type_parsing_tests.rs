...
/// C# Parser_ParsesNumericForLoop (TypeParsingTests.cs:1208): 'for i:T = 1, 5 do end' parses as the numeric for loop with a typed loop variable.
/// The C# red-tree shapes have no full_moon equivalent; the port asserts
/// the clean parse + the round-trip.
#[test]
fn parser_parsesnumericforloop() {
    let parsed_text = "for i:T = 1, 5 do end";
    let result = full_moon::parse_fallible(
        parsed_text,
        options_to_version(&LuaParseOptions::new(LuaSyntaxOptions::LUAU)),
    );
...
/// C# Parser_ParsesGenericForLoop (TypeParsingTests.cs:1249): 'for i:T in iter() do end' parses as the generic for loop with a typed loop variable.
/// The C# red-tree shapes have no full_moon equivalent; the port asserts
/// the clean parse + the round-trip.
#[test]
fn parser_parsesgenericforloop() {
    let parsed_text = "for i:T in iter() do end";
    let result = full_moon::parse_fallible(
        parsed_text,
        options_to_version(&LuaParseOptions::new(LuaSyntaxOptions::LUAU)),
    );
...
/// C# Parser_ParsesTypedNamedParameters (TypeParsingTests.cs:1345): 'function a(b:T, c:A) end' parses as the function declaration with typed named parameters.
/// The C# red-tree shapes have no full_moon equivalent; the port asserts
/// the clean parse + the round-trip.
#[test]
fn parser_parsestypednamedparameters() {
    let parsed_text = "function a(b:T, c:A) end";
    let result = full_moon::parse_fallible(
        parsed_text,
        options_to_version(&LuaParseOptions::new(LuaSyntaxOptions::LUAU)),
    );
...
/// C# Parser_ParsesOccasionallyTypedNamedParameters (TypeParsingTests.cs:1393): 'function a(b, c:A) end' parses as the function declaration with occasionally typed named parameters.
/// The C# red-tree shapes have no full_moon equivalent; the port asserts
/// the clean parse + the round-trip.
#[test]
fn parser_parsesoccasionallytypednamedparameters() {
    let parsed_text = "function a(b, c:A) end";
    let result = full_moon::parse_fallible(
        parsed_text,
        options_to_version(&LuaParseOptions::new(LuaSyntaxOptions::LUAU)),
    );
...
/// C# Parser_ParsesAnonymousFunctionReturnType (TypeParsingTests.cs:1571): 'local a = function() : T end' parses as the anonymous function with a return type.
/// The C# red-tree shapes have no full_moon equivalent; the port asserts
/// the clean parse + the round-trip.
#[test]
fn parser_parsesanonymousfunctionreturntype() {
    let parsed_text = "local a = function() : T end";
    let result = full_moon::parse_fallible(
        parsed_text,
        options_to_version(&LuaParseOptions::new(LuaSyntaxOptions::LUAU)),
    );
...
/// C# Parser_ParsesTypeCastExpression (TypeParsingTests.cs:1650): 'local a = b :: T' parses as the type cast expression.
/// The C# red-tree shapes have no full_moon equivalent; the port asserts
/// the clean parse + the round-trip.
#[test]
fn parser_parsestypecastexpression() {
    let parsed_text = "local a = b :: T";
    let result = full_moon::parse_fallible(
        parsed_text,
        options_to_version(&LuaParseOptions::new(LuaSyntaxOptions::LUAU)),
    );
...
/// C# Parser_ParsesTypeDeclarationStatementWithAdding (TypeParsingTests.cs:1685): 'local a = b :: T + b :: T' parses as the type cast expressions under an add expression.
/// The C# red-tree shapes have no full_moon equivalent; the port asserts
/// the clean parse + the round-trip.
#[test]
fn parser_parsestypedeclarationstatementwithadding() {
    let parsed_text = "local a = b :: T + b :: T";
    let result = full_moon::parse_fallible(
        parsed_text,
        options_to_version(&LuaParseOptions::new(LuaSyntaxOptions::LUAU)),
    );
...
/// C# Parser_ParsesTypeDeclarationStatementWithUnary (TypeParsingTests.cs:1736): 'local a = -b :: T' parses as the type cast expression under a unary minus.
/// The C# red-tree shapes have no full_moon equivalent; the port asserts
/// the clean parse + the round-trip.
#[test]
fn parser_parsestypedeclarationstatementwithunary() {
    let parsed_text = "local a = -b :: T";
    let result = full_moon::parse_fallible(
        parsed_text,
        options_to_version(&LuaParseOptions::new(LuaSyntaxOptions::LUAU)),
...
/// C# Parser_ParsesTypeFunctionDeclarationStatementWithParameters (TypeParsingTests.cs:1946): 'type function serialize(arg) return arg end' parses as the type function declaration with parameters.
/// The C# red-tree shapes have no full_moon equivalent; the port asserts
/// the clean parse + the round-trip.
#[test]
fn parser_parsestypefunctiondeclarationstatementwithparameters() {
    let parsed_text = "type function serialize(arg) return arg end";
    let result = full_moon::parse_fallible(
        parsed_text,
        options_to_version(&LuaParseOptions::new(LuaSyntaxOptions::LUAU)),
    );
...
/// C# Parser_ParsesTypeFunctionDeclarationStatementWithReturnType (TypeParsingTests.cs:1981): 'type function myTypeFunc(): T return types.number end' parses as the type function declaration with a return type.
/// The C# red-tree shapes have no full_moon equivalent; the port asserts
/// the clean parse + the round-trip.
#[test]
fn parser_parsestypefunctiondeclarationstatementwithreturntype() {
    let parsed_text = "type function myTypeFunc(): T return types.number end";
    let result = full_moon::parse_fallible(
        parsed_text,
        options_to_version(&LuaParseOptions::new(LuaSyntaxOptions::LUAU)),
    );
